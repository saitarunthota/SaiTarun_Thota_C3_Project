...
class RestaurantTest {
    ...
    @BeforeEach
    public void restaurantInfoAndItems(){
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        //WRITE UNIT TEST CASE HERE
        Restaurant restaurantSpied = Mockito.spy(restaurant);
        LocalTime timeOfRestaurantIsClosed = LocalTime.parse("23:30:00");;
        Mockito.when(restaurantSpied.getCurrentTime()).thenReturn(timeOfRestaurantIsClosed);
        assertEquals(false,restaurantSpied.isRestaurantOpen());
    }
